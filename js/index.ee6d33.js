...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js11');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/pasted-image-186.png':'images/pasted-image-93.png');
var a='data-src';var e=document.querySelector('.js14');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/twitter-76.png':'images/twitter-38.png');
var a='data-src';var e=document.querySelector('.js15');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/instagram-76.png':'images/instagram-38.png');
var a='data-src';var e=document.querySelector('.js16');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/facebook-76.png':'images/facebook-38.png');
var a='data-src';var e=document.querySelector('.js17');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/youtube-78.png':'images/youtube-39.png');
var e=document.querySelector('.js1');e.setAttribute('src',(dpi>1)?'images/pasted-image-192.png':'images/pasted-image-96.png');
var e=document.querySelector('.js8');e.setAttribute('src',(dpi>1)?'images/aws-logo-412.png':'images/aws-logo-206.png');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
$('form').h5Validate();ldsrc('.js11');ldsrcset('.js18 source');ldsrc('.js14');ldsrcset('.js19 source');ldsrc('.js15');ldsrcset('.js20 source');ldsrc('.js16');ldsrcset('.js21 source');ldsrc('.js17');ldsrcset('.js22 source');wl=new woolite();
wl.init();
...
wl.addAnimation($('.js9')[0], "1.00s", "0.00s", 1, 10);
wl.addAnimation($('.js10')[0], "1.00s", "0.50s", 1, 10);
wl.addAnimation($('.js12')[0], "1.00s", "0.00s", 1, 100);
wl.addAnimation($('.js13')[0], "1.00s", "0.50s", 1, 10);
wl.start();
